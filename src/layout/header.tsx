...
return (
<header className="sticky top-0 z-50 flex items-center justify-center pt-[42px]">
    <div className="w-[1700px] bg-primary rounded-[20px] mx-auto p-2">
        <div className="flex items-center justify-between px-4">
            <div className="flex items-center">
                <a href='#hero'>
                    <p className='font-dynapuff text-2xl font-semibold text-white hover:scale-110 transition duration-200'> $KERMITNOBIZ</p>
                </a>
            </div>
                ...
                <div className="flex items-center space-x-10">
                    <div className="md:flex hidden flex-row space-x-3">
                        <a href=""
                            ...
                            <svg className='fill-white hover:fill-primary' height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href=""
                            className="border-white border-2 hover:bg-white rounded-full transition duration-200">
                            <svg className='fill-white hover:fill-primary' width="32" height="32" viewBox="0 0 167 154" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex md:hidden">
                        <button
                        className="top-0 right-0 z-20 flex items-center justify-center mb-safe"
                        onClick={toggleNav} aria-expanded={isNavOpen} aria-label={isNavOpen ? 'Close navigation'
                        : 'Open navigation' } aria-hidden="true">
                            <div className="block w-8 transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
    ...
    <div className={`${isNavOpen ? 'block' : 'hidden' } md:hidden absolute top-[60px] w-full`}>
        <div className="px-2 pt-2 pb-3 sm:px-3 bg-primary rounded-[20px]">
            <a href="#about"
            ...
            <div className='flex flex-row space-x-3 px-3 pt-3'>
