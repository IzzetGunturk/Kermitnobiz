    ...
    <div className='sm300:mx-10 mx-2 md:mx-20'>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-32">
            ...
            <div className="order-first relative flex flex-col gap-[24px] lg:pt-16">
                ...
                <h1
                    className='font-dynapuff font-medium sm:text-7xl md:text-[45px] lg:text-[90px] text-4xl text-primary'>
                    $KERMITNOBIZ
                </h1>
                <h2 className='font-outfit font-semibold text-lg text-secondary'>
                    Welcome to $KERMITNOBIZ, the memecoin inspired by the iconic Kermit "But that’s none of my business"
                    meme. Stay cool, sip your tea, and ride the crypto waves—because who’s got time for the drama?
                </h2>
